            ...
            <div className="col-8 offset-2">
                <div id="payment-cards-table" className="row">
                    <div id="cards-table-left-side" className="col-xs-10 col-lg-5">
                        <PaymentCard id={"91e50df9-66bf-4bf2-8a60-02b8523d627f"} number="**** **** **** 2312" owner="John Smith"></PaymentCard>
                        <PaymentCard id={"5c45cedc-352d-4941-9c8f-0b376b20791c"} number="**** **** **** 1432" owner="Clara Smith"></PaymentCard>
                        <PaymentCard id={"d0c7f47e-4bb7-45cc-afe5-8807a401ba06"} number="**** **** **** 1875" owner="John Smith"></PaymentCard>
                    </div>
                    <div className="col-xs-2 col-md-2 col-lg-2"></div>
                    <div id="cards-table-right-side" className="col-xs-10 col-lg-5">
                        <PaymentCard id={"1bad8ce4-fd6a-4d6c-96fc-9d2c07f7c5cf"} number="**** **** **** 9082" owner="Elizabet Winter"></PaymentCard>
                        <PaymentCard id={"58dd2a27-c0c0-4921-934c-e205b3cd5947"} number="**** **** **** 5567" owner="Clara Smith"></PaymentCard>
                        <PaymentCard id={"fe0a9c66-2567-441e-83e7-8fda39db9c41"} number="**** **** **** 5422" owner="John Smith"></PaymentCard>
                    </div>
                </div>
