            ...
            <div className="signup-body px-4">
              <Form>
                ...
                <Form.Control
                  ...
                  className="border-dark border-2 mb-4"
                ></Form.Control>
                <PasswordField placeholder="Password" name="password" value={props.values.password} onChange={changeInput}></PasswordField>
                <PasswordField placeholder="Confirm Password" name="confirm" value={props.values.confirm} onChange={changeInput}></PasswordField>
              </Form>
              <Checkbox checked={props.values.accepted} onClick={changeInput} name="accepted" className="signup-checkbox">
                I have read and accept <Link  className="text-orange" to={'/terms'}>Terms of service</Link>.
              </Checkbox>
            </div>
            <div className="signup-footer px-4 mb-2">
              <AcceptButton activate={props.values.accepted} className="signup-button border-dark" onClick={props.onClick}>
                Sign Up
              </AcceptButton>
            </div>
